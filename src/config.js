...
export const config = {
  ...
  forwarder: {
    ...
    bufferSize: num(process.env.BUFFER_SIZE, file.forwarder?.bufferSize, 30),
    bufferRefillThreshold: num(process.env.BUFFER_REFILL_THRESHOLD, file.forwarder?.bufferRefillThreshold, 5),
    maxRetryAttempts: num(process.env.MAX_RETRY_ATTEMPTS, file.forwarder?.maxRetryAttempts, 30),
